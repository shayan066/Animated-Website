...
const Page2 = () => {
  ...
  return (
    <>
      <div id="section2" className="bg-white text-black text-center p-8">
        <h3 className="text-gray-500 font-[anzo3] text-lg">
        ...
        {/* Below data of Svg photos of Tesla, figma, wix Studios, google, behance */}

        <div className="flex items-center justify-center mt-[30px] mx-[250px]">
          <svg
        ...
        <div className="h-0.5 w-1/4 relative bg-black left-1/2 -translate-x-1/2 mt-5"></div>
      </div>
    </>
  );
};
